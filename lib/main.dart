...
import 'ui/screens/library/app_library/app_library_controller.dart';
import 'ui/screens/library/device_library/device_library_controller.dart';
...
Future<void> startApplicationServices() async {
  ...
  Get.lazyPut(() => PlaylistController(), fenix: true); 
   ...
   Get.lazyPut(() => DeviceLibraryController(), fenix: true);
   Get.lazyPut(() => AppLibraryController(), fenix: true);
