...
class PlaylistFull extends Playlist {
  ...
  PlaylistFull({
    ...
    required super.desciption, required this.duration, required this.secondsduration, required this.trackCount, required this.year, this.releted, this.tracks, this.videoId
  });
}
